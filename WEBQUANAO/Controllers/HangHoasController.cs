...
namespace WEBQUANAO.Controllers
{
    ...
    {
        private readonly QlquanaoContext _context;

        public HangHoasController(QlquanaoContext context)
        {
            _context = context;
        }
        ...
        {
            var qlquanaoContext = _context.HangHoas.Include(h => h.MaLoaiNavigation);
            return View(await qlquanaoContext.ToListAsync());
        }
